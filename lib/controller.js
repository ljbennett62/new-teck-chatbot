...
var portfolioHoldingsCall = Promise.promisify(portfoliomgt.getPortfolioHoldings.bind(portfoliomgt));
//var portfolioWelcomeCall = Promise.promisify(portfoliomgt.welcome.bind(portfoliomgt));
  ...
  processMessage: function(_message, callback) {
    ...
    getUser(user).then(function(dbUser) {
      ...
      if( "portfolio_holdings" == intentName ) {
         ...
         // pmanagement.getPortfolioHoldings(portfolio_id);
          portfolioHoldingsCall(portfolio_id);
          ...
          pmanagement.getTopPortfolioHoldings('test');
          //pmanagement.getTopPortfolioHoldings(sessionContext.userProfile.portfolio);
              ...
              var msg = portfoliomgt.welcome(messageResponse.context);
